...
class AdaptiveHomeScreenTest {
    ...
    private val repository = mockk<ZenBreathRepository>(relaxed = true)
    private val syncManager = mockk<ZenBreathSyncManager>(relaxed = true)
    private val viewModel = ZenBreathViewModel(repository, syncManager)
